...
import (
	...
	"github.com/peanut-cc/ent_orm_notes/one_to_one/ent/card"
	"github.com/peanut-cc/ent_orm_notes/one_to_one/ent/user"
)
...
func (c *Card) assignValues(values ...interface{}) error {
	...
	if value, ok := values[1].(*sql.NullTime); !ok {
		return fmt.Errorf("unexpected type %T for field expired", values[1])
	} else if value.Valid {
